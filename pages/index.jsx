  ...
  return (
    <div className="p-0 h-full w-full flex flex-row">
      ...
      <div
        className={
          (isMenu
            ? "w-full lg:w-80 z-40 h-full bg-slate-200 absolute"
      ...
      <div
        ...
        className={
          ...
          " bg-[url(/bg.png)] bg-right bg-no-repeat overflow-y-scroll flex flex-col flex-wrap justify-center lg:content-center content-between"
        }
      >
        <div className="w-3/4 h-fit flex flex-col rounded-xl gap-2">
          {data
