...
export default function Announcement({ title, article, date }) {
  return (
    <div className="group flex sm:flex-row flex-col shadow-md shadow-indigo-400 w-full hover:h-160 sm:hover:h-80 transition-all duration-500 h-16 bg-indigo-200 rounded-xl">
